...
cl %mlt_opt_level% %mlt_includes% /Zi /c /EHsc ..\src\headerlibs_impl.cc
lib headerlibs_impl.obj

:: ---- Unity build for Milton
cl %mlt_opt_level% %mlt_compiler_flags% %mlt_disabled_warnings% %mlt_defines% %mlt_includes%  ..\src\milton_unity_build.cc /FeMilton.exe %mlt_links% headerlibs_impl.lib
