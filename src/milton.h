...
#define  SGL_DO_NOT_DEFINE_DEFAULTS
#include "libnuwen/threads.h"
...
static void milton_init(MiltonState* milton_state, i32 max_width , i32 max_height)
{
    ...
    {
        milton_state->render_queue->work_available      = sgl_create_semaphore(0);
        milton_state->render_queue->completed_semaphore = sgl_create_semaphore(0);
