...
void    ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
    ...
    // glPolygonMode(GL_FRONT_AND_BACK, GL_FILL); // This must be commented until glext.h has a declaration for glPolygonMode
#endif
...
#ifdef GL_POLYGON_MODE
    // glPolygonMode(GL_FRONT_AND_BACK, (GLenum)last_polygon_mode[0]); // This must be commented until glext.h has a declaration for glPolygonMode
#endif
