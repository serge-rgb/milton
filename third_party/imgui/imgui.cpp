...
bool ImGui::ColorEdit4(const char* label, float col[4], bool alpha)
{
    ...
    if (ImGui::IsItemHovered())
        //assert (!"Commenting this out because it doesn't seem to be doing the right thing (clang warning) -Sergio");
        ImGui::SetTooltip("Color:\n(%.2f,%.2f,%.2f,%.2f)\n", col[0], col[1], col[2], col[3]);
                          //IM_F32_TO_INT8(col[0]), IM_F32_TO_INT8(col[1]), IM_F32_TO_INT8(col[2]), IM_F32_TO_INT8(col[3]));
